...
namespace Microsoft.IdentityFramework
{
    ...
    public class UserManager<TUser, TKey> : IDisposable where TUser : class, IUser<TKey> where TKey : IEquatable<TKey>
    {
        ...
        public IPasswordHasher PasswordHasher
        {
            ...
            {
                ThrowIfDisposed();
                _passwordHasher = value ?? throw new ArgumentNullException("value");
            }
        }
        ...
        public IIdentityValidator<TUser> UserValidator
        {
            ...
            {
                ThrowIfDisposed();
                _userValidator = value ?? throw new ArgumentNullException("value");
            }
        }
        ...
        public IIdentityValidator<string> PasswordValidator
        {
            ...
            {
                ThrowIfDisposed();
                _passwordValidator = value ?? throw new ArgumentNullException("value");
            }
        }
        ...
        public IClaimsIdentityFactory<TUser, TKey> ClaimsIdentityFactory
        {
            ...
            {
                ThrowIfDisposed();
                _claimsFactory = value ?? throw new ArgumentNullException("value");
            }
        }
        ...
        public virtual IQueryable<TUser> Users
        {
            get
            {
                if (!(Store is IQueryableUserStore<TUser, TKey> obj))
                {
        ...
        public virtual async Task<IdentityResult> CreateAsync(TUser user)
        {
            ...
            IdentityResult identityResult = await TaskExtensions.WithCurrentCulture(this.UserValidator.ValidateAsync(user));
        ...
        {
            if (!(Store is IUserPasswordStore<TUser, TKey> obj))
            {
        ...
        public virtual async Task<IdentityResult> CreateAsync(TUser user, string password)
        {
            ...
            return await TaskExtensions.WithCurrentCulture(this.CreateAsync(user));
        }
        ...
        {
            this.ThrowIfDisposed();
            TUser user = await TaskExtensions.WithCurrentCulture(this.FindByNameAsync(userName));
            if (user == null)
            {
                return null;
            }
            return (await TaskExtensions.WithCurrentCulture(this.CheckPasswordAsync(user, password))) ? user : null;
        }
        ...
        public virtual async Task<bool> CheckPasswordAsync(TUser user, string password)
        {
            ...
            return await TaskExtensions.WithCurrentCulture(this.VerifyPasswordAsync(passwordStore, user, password));
        }
        ...
        public virtual async Task<bool> HasPasswordAsync(TKey userId)
        {
            this.ThrowIfDisposed();
            IUserPasswordStore<TUser, TKey> passwordStore = this.GetPasswordStore();
            TUser val = await TaskExtensions.WithCurrentCulture(this.FindByIdAsync(userId));
            if (val == null)
            {
            ...
            return await TaskExtensions.WithCurrentCulture(passwordStore.HasPasswordAsync(val));
        }
        ...
        public virtual async Task<IdentityResult> AddPasswordAsync(TKey userId, string password)
        {
            this.ThrowIfDisposed();
            IUserPasswordStore<TUser, TKey> passwordStore = this.GetPasswordStore();
            TUser user = await TaskExtensions.WithCurrentCulture(this.FindByIdAsync(userId));
            if (user == null)
            {
                throw new InvalidOperationException(string.Format(CultureInfo.CurrentCulture, Resources.UserIdNotFound, new object[1]
                {
            ...
            IdentityResult identityResult = await TaskExtensions.WithCurrentCulture(this.UpdatePassword(passwordStore, user, password));
            if (!identityResult.Succeeded)
            {
                return identityResult;
            }
            return await TaskExtensions.WithCurrentCulture(this.UpdateAsync(user));
        }
        ...
        {
            if (!(Store is IUserSecurityStampStore<TUser, TKey> obj))
            {
        ...
        public virtual async Task<string> GetSecurityStampAsync(TKey userId)
        {
            ...
            return await TaskExtensions.WithCurrentCulture(securityStore.GetSecurityStampAsync(val));
        }
        ...
        public virtual async Task<IdentityResult> ResetPasswordAsync(TKey userId, string token, string newPassword)
        {
            ...
            if (!(await TaskExtensions.WithCurrentCulture(this.VerifyUserTokenAsync(userId, "ResetPassword", token))))
            {
                return IdentityResult.Failed(Resources.InvalidToken);
            }
            IUserPasswordStore<TUser, TKey> passwordStore = this.GetPasswordStore();
            IdentityResult identityResult = await TaskExtensions.WithCurrentCulture(this.UpdatePassword(passwordStore, user, newPassword));
            if (!identityResult.Succeeded)
            {
                return identityResult;
            }
        ...
        {
            if (!(Store is IUserLoginStore<TUser, TKey> obj))
            {
        ...
        public virtual async Task<IdentityResult> AddLoginAsync(TKey userId, UserLoginInfo login)
        {
            ...
            if (await TaskExtensions.WithCurrentCulture(this.FindAsync(login)) != null)
            {
        ...
        public virtual async Task<IList<UserLoginInfo>> GetLoginsAsync(TKey userId)
        {
            ...
            return await TaskExtensions.WithCurrentCulture(loginStore.GetLoginsAsync(val));
        }

        private IUserClaimStore<TUser, TKey> GetClaimStore()
        {
            if (!(Store is IUserClaimStore<TUser, TKey> obj))
            {
        ...
        public virtual async Task<IList<Claim>> GetClaimsAsync(TKey userId)
        {
            ...
            return await TaskExtensions.WithCurrentCulture(claimStore.GetClaimsAsync(val));
        }

        private IUserRoleStore<TUser, TKey> GetUserRoleStore()
        {
            if (!(Store is IUserRoleStore<TUser, TKey> obj))
            {
        ...
        public virtual async Task<IdentityResult> AddToRoleAsync(TKey userId, string role)
        {
            ...
            if (((ICollection<string>)(await TaskExtensions.WithCurrentCulture(userRoleStore.GetRolesAsync(user)))).Contains(role))
            {
        ...
        public virtual async Task<IdentityResult> AddToRolesAsync(TKey userId, params string[] roles)
        {
            ...
            IList<string> userRoles = await TaskExtensions.WithCurrentCulture(userRoleStore.GetRolesAsync(user));
        ...
        public virtual async Task<IdentityResult> RemoveFromRoleAsync(TKey userId, string role)
        {
            ...
            if (!(await TaskExtensions.WithCurrentCulture(userRoleStore.IsInRoleAsync(user, role))))
            {
                return new IdentityResult(Resources.UserNotInRole);
            }
        ...
        public virtual async Task<IList<string>> GetRolesAsync(TKey userId)
        {
            ...
            return await TaskExtensions.WithCurrentCulture(userRoleStore.GetRolesAsync(val));
        }
        ...
        public virtual async Task<bool> IsInRoleAsync(TKey userId, string role)
        {
            ...
            return await TaskExtensions.WithCurrentCulture(userRoleStore.IsInRoleAsync(val, role));
        }

        internal IUserEmailStore<TUser, TKey> GetEmailStore()
        {
            if (!(Store is IUserEmailStore<TUser, TKey> obj))
            {
        ...
        public virtual async Task<string> GetEmailAsync(TKey userId)
        {
            ...
            return await TaskExtensions.WithCurrentCulture(store.GetEmailAsync(val));
        }
        ...
        public virtual async Task<IdentityResult> ConfirmEmailAsync(TKey userId, string token)
        {
            ...
            if (!(await TaskExtensions.WithCurrentCulture(this.VerifyUserTokenAsync(userId, "Confirmation", token))))
            {
                return IdentityResult.Failed(Resources.InvalidToken);
            }
        ...
        public virtual async Task<bool> IsEmailConfirmedAsync(TKey userId)
        {
            ...
            return await TaskExtensions.WithCurrentCulture(store.GetEmailConfirmedAsync(val));
        }

        internal IUserPhoneNumberStore<TUser, TKey> GetPhoneNumberStore()
        {
            if (!(Store is IUserPhoneNumberStore<TUser, TKey> obj))
            {
        ...
        public virtual async Task<string> GetPhoneNumberAsync(TKey userId)
        {
            ...
            return await TaskExtensions.WithCurrentCulture(store.GetPhoneNumberAsync(val));
        }
        ...
        public virtual async Task<IdentityResult> ChangePhoneNumberAsync(TKey userId, string phoneNumber, string token)
        {
            ...
            if (await TaskExtensions.WithCurrentCulture(this.VerifyChangePhoneNumberTokenAsync(userId, token, phoneNumber)))
            {
                await store.SetPhoneNumberAsync(user, phoneNumber).WithCurrentCulture();
        ...
        public virtual async Task<bool> IsPhoneNumberConfirmedAsync(TKey userId)
        {
            ...
            return await TaskExtensions.WithCurrentCulture(store.GetPhoneNumberConfirmedAsync(val));
        }

        internal async Task<SecurityToken> CreateSecurityTokenAsync(TKey userId)
        {
            Encoding unicode = Encoding.Unicode;
            return new SecurityToken(unicode.GetBytes(await TaskExtensions.WithCurrentCulture(this.GetSecurityStampAsync(userId))));
        }
        ...
        {
            this.ThrowIfDisposed();
            return Rfc6238AuthenticationService.GenerateCode(await TaskExtensions.WithCurrentCulture(this.CreateSecurityTokenAsync(userId)), phoneNumber).ToString("D6", CultureInfo.InvariantCulture);
        }
        ...
        {
            this.ThrowIfDisposed();
            SecurityToken securityToken = await TaskExtensions.WithCurrentCulture(this.CreateSecurityTokenAsync(userId));
        ...
        public virtual async Task<bool> VerifyUserTokenAsync(TKey userId, string purpose, string token)
        {
            ...
            return await TaskExtensions.WithCurrentCulture(this.UserTokenProvider.ValidateAsync(purpose, token, this, val));
        }
        ...
        public virtual async Task<string> GenerateUserTokenAsync(string purpose, TKey userId)
        {
            ...
            return await TaskExtensions.WithCurrentCulture(this.UserTokenProvider.GenerateAsync(purpose, this, val));
        }
        ...
        public virtual void RegisterTwoFactorProvider(string twoFactorProvider, IUserTokenProvider<TUser, TKey> provider)
        {
            ...
            TwoFactorProviders[twoFactorProvider] = provider ?? throw new ArgumentNullException("provider");
        }
        ...
        public virtual async Task<IList<string>> GetValidTwoFactorProvidersAsync(TKey userId)
        {
            ...
            foreach (KeyValuePair<string, IUserTokenProvider<TUser, TKey>> item in this.TwoFactorProviders)
            {
                KeyValuePair<string, IUserTokenProvider<TUser, TKey>> f = item;
                if (await TaskExtensions.WithCurrentCulture(f.Value.IsValidProviderForUserAsync(this, user)))
                {
                    results.Add(f.Key);
                }
        ...
        public virtual async Task<bool> VerifyTwoFactorTokenAsync(TKey userId, string twoFactorProvider, string token)
        {
            ...
            return await TaskExtensions.WithCurrentCulture(this._factors[twoFactorProvider].ValidateAsync(twoFactorProvider, token, this, val));
        }
        ...
        public virtual async Task<string> GenerateTwoFactorTokenAsync(TKey userId, string twoFactorProvider)
        {
            ...
            return await TaskExtensions.WithCurrentCulture(this._factors[twoFactorProvider].GenerateAsync(twoFactorProvider, this, val));
        }
        ...
        {
            if (!(Store is IUserTwoFactorStore<TUser, TKey> obj))
            {
        ...
        public virtual async Task<bool> GetTwoFactorEnabledAsync(TKey userId)
        {
            ...
            return await TaskExtensions.WithCurrentCulture(store.GetTwoFactorEnabledAsync(val));
        }
        ...
        public virtual async Task SendEmailAsync(TKey userId, string subject, string body)
        {
            ...
            if (this.EmailService != null)
            {
                ...
                identityMessage2.Destination = await TaskExtensions.WithCurrentCulture(this.GetEmailAsync(userId));
        ...
        public virtual async Task SendSmsAsync(TKey userId, string message)
        {
            ...
            if (this.SmsService != null)
            {
                IdentityMessage identityMessage = new IdentityMessage();
                IdentityMessage identityMessage2 = identityMessage;
                identityMessage2.Destination = await TaskExtensions.WithCurrentCulture(this.GetPhoneNumberAsync(userId));
        ...
        {
            if (!(Store is IUserLockoutStore<TUser, TKey> obj))
            {
        ...
        public virtual async Task<bool> IsLockedOutAsync(TKey userId)
        {
            ...
            if (!(await TaskExtensions.WithCurrentCulture(store.GetLockoutEnabledAsync(user))))
            {
                return false;
            }
            return await TaskExtensions.WithCurrentCulture(store.GetLockoutEndDateAsync(user)) >= DateTimeOffset.UtcNow;
        }
        ...
        public virtual async Task<bool> GetLockoutEnabledAsync(TKey userId)
        {
            ...
            return await TaskExtensions.WithCurrentCulture(store.GetLockoutEnabledAsync(val));
        }
        ...
        public virtual async Task<DateTimeOffset> GetLockoutEndDateAsync(TKey userId)
        {
            ...
            return await TaskExtensions.WithCurrentCulture(store.GetLockoutEndDateAsync(val));
        }
        ...
        public virtual async Task<IdentityResult> AccessFailedAsync(TKey userId)
        {
            ...
            if (await TaskExtensions.WithCurrentCulture(store.IncrementAccessFailedCountAsync(user)) >= this.MaxFailedAccessAttemptsBeforeLockout)
            {
        ...
        public virtual async Task<IdentityResult> ResetAccessFailedCountAsync(TKey userId)
        {
            ...
            if (await TaskExtensions.WithCurrentCulture(this.GetAccessFailedCountAsync(user.Id)) == 0)
            {
                return IdentityResult.Success;
            }
            await store.ResetAccessFailedCountAsync(user).WithCurrentCulture();
        ...
        public virtual async Task<int> GetAccessFailedCountAsync(TKey userId)
        {
            ...
            return await TaskExtensions.WithCurrentCulture(store.GetAccessFailedCountAsync(val));
        }
